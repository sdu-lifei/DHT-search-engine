...
def send_handshake(the_socket, infohash,peerid):
...
def download_metadata(address, infohash, metadata_queue, timeout=5,peerid=1):
    metadata = None
    start_time = time()
    ...
    try:
        ...
        # handshake
        send_handshake(the_socket, infohash,peerid)
